...
<div class="signupSection">
    ...
    <form action="../modelos/registro_bicis.php" method="POST" class="signupForm" name="signupform">
        <h2>REGISTRAR DATOS DE MI BICI</h2>
        <ul class="noBullet">
        <?php echo isset($_SESSION['usuario']) ? $_SESSION['usuario'] : ''; ?>
            ...
            <li id="center-btn">
              <input type="submit" id="join-btn" name="registrar" alt="Registrar" value="REGISTRAR">
            </li>
        </ul>
        <br>
        <p><a href="../../Aprendiz/perfil.html">Volver al perfil</a></p>
    </form>
</div>
</body>
</html>